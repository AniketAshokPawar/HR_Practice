...
In my current role, I work as a Manual and Automation tester.

As i work in Agile framework, I participate in activities such as daily stand-ups, sprint planning, backlog refinement or grooming, sprint reviews, and retrospectives. During grooming, I understand the requirements and acceptance criteria and provide my inputs from the testing perspective.

In manual testing, based on the acceptance criteria, I create test cases and prepare the required test data. I then execute the test cases and validate the functionality against the requirements. If I find any issues, I report defects with proper details such as the title, description, environment, severity, priority, screenshots, and videos. I also perform integration testing and regression testing, especially during the later sprints of the PI.
